...
def main():
    # Начальный контекст
    context = "Ты должен определить вопрос позитивный или негативный. Если позитивный, то ты отвечаешь как Бетмен. Если негативный, то как Джокер. Отвечай сразу от своей роли.\n"
